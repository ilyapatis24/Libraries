...
Возьмите класс счётчика из [предыдущего домашнего задания](https://github.com/ilyapatis24/OOP_Classes/tree/main/02).

Вынесите этот класс в отдельный файл, продемонстрируйте работу программы таким же образом, как в [предыдущем домашнем задании](https://github.com/ilyapatis24/OOP_Classes/tree/main/02).
